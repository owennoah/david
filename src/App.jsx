        ...
        <div className="contact-section-wrapper">
          <section id="contact" className="contact-section fade-in-section">
            <div className="section-header center-align" style={{ marginBottom: '4rem' }}>
              <span className="section-subtitle" style={{ color: '#9FD458', fontFamily: 'monospace', fontStyle: 'normal', fontSize: '0.85rem', letterSpacing: '1px', textTransform: 'uppercase' }}>// Secure Communication Link</span>
              ...
              <div className="contact-info">
                ...
                <div className="contact-cards">
                  <div className="ci-card">
                    <div className="ci-icon" style={{ color: '#9FD458' }}>
